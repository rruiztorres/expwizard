<template>
    <div>
        ...
        <div v-else>
            <v-alert text type="error" >Aun no se ha definido un presupuesto base. Por favor, complete la sección "Presupuesto, lotes y anualidades" 
                y posteriormente regrese a esta sección.
            </v-alert>
        </div>
    </div>
</template>
